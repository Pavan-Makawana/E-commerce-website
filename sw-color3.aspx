<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sw-color3.aspx.cs" Inherits="sw_color3" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD Xaspx 1.0 Transitional//EN" "http://www.w3.org/TR/xaspx1/DTD/xaspx1-transitional.dtd">
...
<div class='navbar'>
    ...
    <a href="img4.aspx"><img src="back1.png" id="back-button" alt=""></a>
    <div class="center">
       ...
       <br>
        <h1 class="color-h1">DELTA PEDESTAL PREMIUM WHITE CERAMIC WASH BASIN PEDESTAL WASH BASIN PEDESTAL BASIN </h1> 
       <br>
        <ol id="first-ol">
       ...
       <form id="form1" runat="server">
            <span class="color-span2">
                ...
                <asp:TextBox ID="TextBox1" size=2px class="color-input" runat="server"></asp:TextBox>
        </center>
            </span>
            <asp:HiddenField ID="HiddenField1" Value="INART CERAMIC PEDESTAL FREE STANDING WASH BASIN" runat="server" />
            <asp:HiddenField ID="HiddenField2" Value="11111" runat="server" />  
