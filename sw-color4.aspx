<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sw-color4.aspx.cs" Inherits="sw_color4" %>
...
<div class='navbar'>
    ...
    <div class="center">
       ...
       <br>
       <h3 id="price">Price :<span class="color-span1"><img src="rupee_img.png" alt="" id="rupee">5,605</span></h3>
       <br>
        <form id="form1" runat="server">
            ...
            <asp:HiddenField ID="HiddenField1" Value="ARVIND SANITARY BROWN GLASS WASH BASIN" runat="server" />
            <asp:HiddenField ID="HiddenField2" Value="5605" runat="server" />  
