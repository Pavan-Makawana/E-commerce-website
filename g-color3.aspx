<%@ Page Language="C#" AutoEventWireup="true" CodeFile="g-color3.aspx.cs" Inherits="g_color3" %>
    ...
    <div class="center">
       ...
       <br>
        <form id="form1" runat="server">
            ...
            <asp:HiddenField ID="HiddenField1" Value="STATUARIO EXTRA WHITE GRANITE" runat="server" />
            <asp:HiddenField ID="HiddenField2" Value="250" runat="server" />
