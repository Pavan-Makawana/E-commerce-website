<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cp-color5.aspx.cs" Inherits="cp_color5" %>
...
<div class='navbar'>
    ...
    <div class="center">
       ...
       <form id="form1" runat="server">
            ...
            <asp:HiddenField ID="HiddenField1" Value="CEMENT POLES" runat="server" />
            <asp:HiddenField ID="HiddenField2" Value="180" runat="server" />  
