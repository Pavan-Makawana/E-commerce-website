<%@ Page Language="C#" AutoEventWireup="true" CodeFile="m-color5.aspx.cs" Inherits="m_color5" %>
...
<div class='navbar'>
    ...
    <a href="img3.aspx"><img src="back1.png" id="back-button" alt=""></a>
    <div class="center">
       ...
       <br>
        <form id="form1" runat="server">
            ...
            <asp:HiddenField ID="HiddenField1" Value="POLISHED BEIGE ITALIAN MARBLE" runat="server" />
            <asp:HiddenField ID="HiddenField2" Value="100" runat="server" />
