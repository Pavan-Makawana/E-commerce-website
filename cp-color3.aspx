<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cp-color3.aspx.cs" Inherits="cp_color3" %>
...
<div class='navbar'>
    ...
    <div class="center">
       ...
       <form id="form1" runat="server">
            ...
            <asp:HiddenField ID="HiddenField1" Value="POLISHED RCC FENCING POLES" runat="server" />
            <asp:HiddenField ID="HiddenField2" Value="270" runat="server" />  
