<%@ Page Language="C#" AutoEventWireup="true" CodeFile="w-color1.aspx.cs" Inherits="w_color1" %>
    ...
    <div class="center">
       ...
       <br>
        <form id="form1" runat="server">
            ...
            <asp:HiddenField ID="HiddenField1" Value="NEXIS Desiner Table Top Counter Top Wash Basin" runat="server" />
            <asp:HiddenField ID="HiddenField2" Value="2399" runat="server" />  
