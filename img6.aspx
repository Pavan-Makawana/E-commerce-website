<%@ Page Language="C#" AutoEventWireup="true" CodeFile="img6.aspx.cs" Inherits="img6" %>
...
<div class='navbar'>
    ...
    <h1 class="img-h1">WASH BASIN</h1>
    <nav class="nav-class">
        <div class="main-line-1">
            <div class="img-1">
                <h2>Black</h2>
                <a href="w-color1.aspx"><img src="img\wish_basine\w11.jpg" alt=""></a>
           </div>
           <div class="img-2"> 
               <h2>Orange</h2>
               <a href="w-color2.aspx"><img src="img\wish_basine\w21.jpg" alt=""></a>
           </div>
           <div class="img-3"> 
            <h2>Rose Gold</h2>
            <a href="w-color3.aspx"><img src="img\wish_basine\w31.jpg" alt=""></a>
        </div>
       </div>
       <div class="main-line-2">
           <div class="img-4">
               <h2>Black & White</h2>
               <a href="w-color4.aspx"><img src="img\wish_basine\w41.jpg" alt=""></a>
          </div>
          <div class="img-5"> 
              <h2>Black</h2>
              <a href="w-color5.aspx"><img src="img\wish_basine\w51.jpg" alt=""></a>
          </div>
          <div class="img-6"> 
            <h2>White</h2>
            <a href="w-color6.aspx"><img src="img\wish_basine\w61.jpg" alt=""></a>
        </div>
      </div>
</nav>
