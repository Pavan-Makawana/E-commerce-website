<%@ Page Language="C#" AutoEventWireup="true" CodeFile="w-color4.aspx.cs" Inherits="w_color4" %>
...
<div class='navbar'>
    ...
    <a href="img6.aspx"><img src="back1.png" id="back-button" alt=""></a>
    <div class="center">
       ...
       <br>
       <h3 id="price">Price :<span class="color-span1"><img src="rupee_img.png" alt="" id="rupee">2,844</span></h3>
       <form id="form1" runat="server">
            ...
            <asp:HiddenField ID="HiddenField1" Value="DELTA Premium Designer Ceramic Wash Basin" runat="server" />
            <asp:HiddenField ID="HiddenField2" Value="2844" runat="server" />  
