<%@ Page Language="C#" AutoEventWireup="true" CodeFile="g-color2.aspx.cs" Inherits="g_color2" %>
    ...
    <div class="center">
       ...
       <br>
        <form id="form1" runat="server">
            ...
            <asp:HiddenField ID="HiddenField1" Value="BLUE PEARL NORTH INDIA GRANITE " runat="server" />
            <asp:HiddenField ID="HiddenField2" Value="190" runat="server" />
