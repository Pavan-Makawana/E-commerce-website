<%@ Page Language="C#" AutoEventWireup="true" CodeFile="w-color3.aspx.cs" Inherits="w_color3" %>
...
<div class='navbar'>
    ...
    <div class="center">
       ...
       <br>
       <h3 id="price">Price :<span class="color-span1"><img src="rupee_img.png" alt="" id="rupee">5,450</span></h3>
       <form id="form1" runat="server">
            ...
            <asp:HiddenField ID="HiddenField1" Value="JINBIO CERAMIC Luxurious Wash Basin" runat="server" />
            <asp:HiddenField ID="HiddenField2" Value="5450" runat="server" />  
