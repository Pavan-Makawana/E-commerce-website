<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sw-color6.aspx.cs" Inherits="sw_color6" %>
    ...
    <div class="center">
       ...
       <h3 id="price">Price :<span class="color-span1"><img src="rupee_img.png" alt="" id="rupee">12,999</span></h3>
        <form id="form1" runat="server">
            ...
            <asp:HiddenField ID="HiddenField1" Value="BASIN SINK WITH FAUCET FREE STAND HAND WASH BASIN" runat="server" />
            <asp:HiddenField ID="HiddenField2" Value="12999" runat="server" />  
