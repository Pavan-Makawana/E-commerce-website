<%@ Page Language="C#" AutoEventWireup="true" CodeFile="w-color2.aspx.cs" Inherits="w_color2" %>
    ...
    <div class="center">
       ...
       <br>
        <form id="form1" runat="server">
            ...
            <asp:HiddenField ID="HiddenField1" Value="JOYO CERA Coutertop Wash Basin" runat="server" />
            <asp:HiddenField ID="HiddenField2" Value="5250" runat="server" />  
