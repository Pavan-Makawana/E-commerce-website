<%@ Page Language="C#" AutoEventWireup="true" CodeFile="img5.aspx.cs" Inherits="img5" %>
...
<div class='navbar'>
    ...
    <h1 class="img-h1">CEMENT PRODUCTS</h1>
    <nav class="nav-class">
        <div class="main-line-1">
            <div class="img-1">
                <h2>Window Frame</h2>
                <a href="cp-color1.aspx"><img src="img/cement_product/cp11.jpeg" alt=""></a>
           </div>
           <div class="img-2"> 
               <h2>Y Shape Poles</h2>
               <a href="cp-color2.aspx"><img src="img/cement_product/cp21.jpeg" alt=""></a>
           </div>
           <div class="img-3"> 
            <h2>Poles</h2>
            <a href="cp-color3.aspx"><img src="img/cement_product/cp31.png" alt=""></a>
        </div>
       </div>
       <div class="main-line-2">
           <div class="img-4">
               <h2>Rcc Poles</h2>
               <a href="cp-color4.aspx"><img src="img/cement_product/cp41.jpeg" alt=""></a>
          </div>
          <div class="img-5"> 
              <h2>Cement Poles</h2>
              <a href="cp-color5.aspx"><img src="img/cement_product/cp51.jpeg" alt=""></a>
          </div>
          <div class="img-6"> 
            <h2>Lotus Window</h2>
            <a href="cp-color6.aspx"><img src="img/cement_product/cp61.jpeg" alt=""></a>
        </div>
      </div>
    </nav>
