<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sw-color5.aspx.cs" Inherits="sw_color5" %>
    ...
    <div class="center">
       ...
       <br>
        <form id="form1" runat="server">
            ...
            <asp:HiddenField ID="HiddenField1" Value="INART CERAMIC PEDESTAL FREE STANDING SQUARE WASH BASIN" runat="server" />
            <asp:HiddenField ID="HiddenField2" Value="9999" runat="server" />  
