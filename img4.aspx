<%@ Page Language="C#" AutoEventWireup="true" CodeFile="img4.aspx.cs" Inherits="img4" %>
...
<div class='navbar'>
    ...
    <h1 class="img-h1">STAND WASH BASIN</h1>
    <nav class="nav-class">
        <div class="main-line-1">
            <div class="img-1">
                <h2>Black & Gold</h2>
                <a href="sw-color1.aspx"><img src="img/wish_basine_stand/sw11.webp" alt=""></a>
           </div>
           <div class="img-2"> 
               <h2>Black & White</h2>
               <a href="sw-color2.aspx"><img src="img/wish_basine_stand/sw21.png" alt=""></a>
           </div>
           <div class="img-3"> 
            <h2>White</h2>
            <a href="sw-color3.aspx"><img src="img/wish_basine_stand/sw31.jpg" alt=""></a>
        </div>
       </div>
       <div class="main-line-2">
           <div class="img-4">
               <h2>Brown Glass</h2>
               <a href="sw-color4.aspx"><img src="img/wish_basine_stand/sw41.jpg" alt=""></a>
          </div>
          <div class="img-5"> 
              <h2>Square Wash Basin</h2>
              <a href="sw-color5.aspx"><img src="img/wish_basine_stand/sw51.png" alt=""></a>
          </div>
          <div class="img-6"> 
            <h2>Pedestal Sink</h2>
            <a href="sw-color6.aspx"><img src="img/wish_basine_stand/sw61.jpg" alt=""></a>
        </div>
      </div>
    </nav>
