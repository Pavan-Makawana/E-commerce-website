<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cp-color1.aspx.cs" Inherits="cp_color1" %>
...
<div class='navbar'>
    ...
    <a href="img5.aspx"><img src="back1.png" id="back-button" alt=""></a>
    <div class="center">
       ...
       <form id="form1" runat="server">
            ...
            <asp:HiddenField ID="HiddenField1" Value="RECTANGULAR NON POLISHED CEMENT WINDOW FRAME" runat="server" />
            <asp:HiddenField ID="HiddenField2" Value="1200" runat="server" />  
