<%@ Page Language="C#" AutoEventWireup="true" CodeFile="m-color3.aspx.cs" Inherits="m_color3" %>
    ...
    <div class="center">
       ...
       <br>
        <form id="form1" runat="server">
            ...
            <asp:HiddenField ID="HiddenField1" Value="WHITE INDIAN STATUARIO MARBLE" runat="server" />
            <asp:HiddenField ID="HiddenField2" Value="200" runat="server" />
