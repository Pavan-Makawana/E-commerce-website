<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cp-color6.aspx.cs" Inherits="cp_color6" %>
...
<div class='navbar'>
    ...
    <div class="center">
       ...
       <form id="form1" runat="server">
            ...
            <asp:HiddenField ID="HiddenField1" Value="LOTUS DESIGN CEMENT WINDOW" runat="server" />
            <asp:HiddenField ID="HiddenField2" Value="550" runat="server" />  
