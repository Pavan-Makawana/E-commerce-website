<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cp-color4.aspx.cs" Inherits="cp_color4" %>
...
<div class='navbar'>
    ...
    <div class="center">
       ...
       <form id="form1" runat="server">
            ...
            <asp:HiddenField ID="HiddenField1" Value="RCC PRECAST FENCING POLES" runat="server" />
            <asp:HiddenField ID="HiddenField2" Value="220" runat="server" />  
