<%@ Page Language="C#" AutoEventWireup="true" CodeFile="g-color4.aspx.cs" Inherits="g_color4" %>
    ...
    <div class="center">
       ...
       <br>
        <form id="form1" runat="server">
            ...
            <asp:HiddenField ID="HiddenField1" Value="ROSY PINK GRANITE" runat="server" />
            <asp:HiddenField ID="HiddenField2" Value="70" runat="server" />
