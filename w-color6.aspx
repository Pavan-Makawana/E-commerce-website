<%@ Page Language="C#" AutoEventWireup="true" CodeFile="w-color6.aspx.cs" Inherits="w_color6" %>
...
<div class='navbar'>
    ...
    <div class="center">
       ...
       <form id="form1" runat="server">
            ...
            <asp:HiddenField ID="HiddenField1" Value="DELTA 2 In 1 Table Top Wash Basin" runat="server" />
            <asp:HiddenField ID="HiddenField2" Value="2499" runat="server" />  
