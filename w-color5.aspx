<%@ Page Language="C#" AutoEventWireup="true" CodeFile="w-color5.aspx.cs" Inherits="w_color5" %>
...
<div class='navbar'>
    ...
    <div class="center">
       ...
       <form id="form1" runat="server">
            ...
            <asp:HiddenField ID="HiddenField1" Value="KEMJO Sanito Ceramic Wash Basin" runat="server" />
            <asp:HiddenField ID="HiddenField2" Value="2999" runat="server" />  
