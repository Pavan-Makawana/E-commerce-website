<%@ Page Language="C#" AutoEventWireup="true" CodeFile="g-color1.aspx.cs" Inherits="g_color1" ClassName="logout.cs" %>
    ...
    <div class="center">
       ...
       <br>
        <form id="form1" runat="server">
            ...
            <asp:HiddenField ID="HiddenField1" Value="BLACK GALAXY GOLDEN STAR GRANITE" runat="server" />
