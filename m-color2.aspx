<%@ Page Language="C#" AutoEventWireup="true" CodeFile="m-color2.aspx.cs" Inherits="m_color2" %>
...
<div class='navbar'>
    ...
    <div class="center">
       ...
       <form id="form1" runat="server">
            ...
            <asp:HiddenField ID="HiddenField1" Value="INDIAN BLACK MARQUINO MARBLE" runat="server" />
            <asp:HiddenField ID="HiddenField2" Value="150" runat="server" />
