<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cp-color2.aspx.cs" Inherits="cp_color2" %>
...
<div class='navbar'>
    ...
    <div class="center">
       ...
       <form id="form1" runat="server">
            ...
            <asp:HiddenField ID="HiddenField1" Value="RCC Y SHAPE FENCING POLES" runat="server" />
            <asp:HiddenField ID="HiddenField2" Value="300" runat="server" />  
