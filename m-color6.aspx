<%@ Page Language="C#" AutoEventWireup="true" CodeFile="m-color6.aspx.cs" Inherits="m_color6" %>
    ...
    <div class="center">
       ...
       <br>
        <form id="form1" runat="server">
            ...
            <asp:HiddenField ID="HiddenField1" Value="POLISHED GREEN MARBLE SLAB" runat="server" />
            <asp:HiddenField ID="HiddenField2" Value="75" runat="server" />
